...
<script type="text/javascript">
	...
	function profileList(){
		...
		var link = "ProfileList.jsp?page=1&id="+pageId;
	...
	function acceptFriendList(){
		var formdata = document.acceptFriend;
		var popUp = "acceptFriend" 
		window.open("", popUp, 'width=600px,height=300px,toolbars=no,scrollbars=no'); 
		formdata.target = popUp;
		formdata.action = "/semi_project/acceptFriendListCont";
	
		formdata.submit();
	}
	function editPageName(){
		var pageName = prompt('새로운 페이지명을 입력하세요', '미니홈피');
	
		 $.ajax({
				url:"/semi_project/pageNameCont",
		      	type:"GET",
		       	dataType:"text",
		...
		<div id = "main2">
			<div id = "side_left"><br> TODAY <font color = "red" style="margin-bottom:10px">2</font> | TOTAL 30
			   	<div id = "left_back">
				    ...
				    <div id = "side_left_box2">
				    	...
				    	<div id="b" >
				    	<input type="hidden" value="<%=s%>" id="profileId">
			...
			<div id = "mid_content">
			    ...
			    <div id = "mid_back1">
			    	...
			    	<div id="m_b" ><a href="javascript:editPageName();" style="text-decoration:none;">EDIT</a></div>
			    	<form name="acceptFriend" id="acceptFriend" method="get">
			    		<input type="hidden" value="<%=s%>" id="sessionId" name="sessionId">
			    	</form>
			    	<div id="m_c" ><a href="#" style="text-decoration:none;" onclick="acceptFriendList()"> 일촌관리</a></div>
			    </div>
			    <div class = "mid_back2">
